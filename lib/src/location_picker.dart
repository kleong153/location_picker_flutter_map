...
class FlutterLocationPicker extends StatefulWidget {
  ...
  /// use to get the address for auto search when enter the picker
...
class _FlutterLocationPickerState extends State<FlutterLocationPicker> with TickerProviderStateMixin {
  ...
  void setNameCurrentPos(double latitude, double longitude) async {
    ...
    try {
      ...
      _searchController.text = decodedResponse['display_name'] ?? "This Location is not accessible";
      setState(() {});
  ...
  _handleAutoSearch() {
    _searchController.text = widget.initAddress!;
